...
export default function ComputerScreen({
  ...
  return (
    <div className="flex flex-col items-center text-center w-full h-full space-y-4 relative bg-gradient-to-b from-[#0a0013] via-[#140025] to-[#1b0036] p-4 rounded-2xl shadow-[0_0_25px_#a855f7] border border-pink-500/30">
